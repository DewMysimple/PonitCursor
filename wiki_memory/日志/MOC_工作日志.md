...
| 2026-09-11 | bug | 保证在 Obsidian 划词后立即按 Ctrl+Shift+H 写入 `==` 仍由 Microsoft Zira Desktop 播报完整原词；同时让 `PointCursor.zip` 解压内容直接位于程序根层。 | archived | obsidian-highlight-and-flat-package | [[日志/2026-09-11-兼容Obsidian快速高亮并扁平化发布包.md|2026-09-11｜兼容 Obsidian 快速高亮并扁平化发布包]] |
